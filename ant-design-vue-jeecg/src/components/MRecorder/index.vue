<template>
  <div class="wrapper">
    <a-row>
      <a-col>
        <a-icon :type="(recording==true)?'loading':'audio'" :class="['mrecorder', {anirecorder: recording } ]" @click="handleClick"/>
      </a-col>
    </a-row>
    <a-row>
      <a-col>
...
<script>
  import { MediaStreamRecorder } from '@/components/_util/MediaStreamRecorder.js'
  export default {
    name: 'MRecorder',
    props: {
      timelimit: {
